...
export const DEFAULT_SUPPORT_UNLOCKS = [
  {
    title: "Weekly Content",
    description: "New tutorials, behind-the-scenes posts, and short dev logs.",
  },
  {
    title: "Community Perks",
    description: "Priority replies, polls, and member-only interaction spaces.",
  },
  {
    title: "Gear & Tools",
    description: "Support goes into software, hosting, and better production setup.",
  },
  {
    title: "Shoutouts",
    description: "Top supporters get highlighted in upcoming creator posts.",
  },
];

export function normalizeSupportUnlocks(input) {
...
export function serializeSettingsSnapshot(snapshot) {
  ...
  return JSON.stringify({
    ...
    supportUnlocks: normalizeSupportUnlocks(snapshot?.supportUnlocks),
    links: sortedLinks,
